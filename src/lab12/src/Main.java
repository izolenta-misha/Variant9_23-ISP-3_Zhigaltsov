public class Main {
    public static void main(String[] args) {
        ...
        AbstractService[] services = {
                new ConcreteService(AbstractService.generateID(), "Обычная уборка", 1500, 2, 0.1),
                new PremiumService(AbstractService.generateID(), "Премиум-уборка", 2000, 3, 1.5),
                new ConcreteService(AbstractService.generateID(), "Экспресс-уборка", 1000, 1, 0.05)
        };
        ServiceProcesoor.processServices(services);
    }
}
